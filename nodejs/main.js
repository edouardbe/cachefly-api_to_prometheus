...
const POPS = {
    ...
    'gua1' : { city:'Guatemala City', country : 'Guatemala', continent : 'N. America' } ,
    ...
    'mex1' : { city:'Mexico City', country : 'Mexico', continent : 'N. America' } ,
...
if (parsedArguments.get("bypass-initial-test") == false) {
    ...
    var test_file = "cachefly_metrics_exporter.test"
